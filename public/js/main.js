...
function setupNetworkHandlers() {
    // Core game callbacks (room, player, enemy, zone management)
    setupGameCallbacks(gameState.networkManager, gameState, {
    ...
    setupTankCallbacks(gameState.networkManager, gameState);
}
